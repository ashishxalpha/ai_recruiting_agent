    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Overview of your AI Recruiting Copilot Platform
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground text-orange-500">Requires attention</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Real-time activity stream will be displayed here using SSE.
            </p>
          </CardContent>
        </Card>
        <Card className="col-span-3">
          <CardHeader>
            ...
            <CardDescription>Candidates matching open requirements.</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Candidate match list will be displayed here.
            </p>
          </CardContent>
        </Card>
      </div>
