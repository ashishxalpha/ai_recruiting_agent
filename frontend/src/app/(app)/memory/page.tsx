...
export default function MemoryExplorerPage() {
  ...
  const { data: memoryData } = useMemoryList();
  const firstMemoryId = memoryData?.data?.memories?.[0]?.id || "00000000-0000-0000-0000-000000000000";
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col min-h-0">
        ...
        <div className="flex-1 mt-4 min-h-0 overflow-auto pb-4">
          ...
          <TabsContent value="timeline" className="h-full m-0">
            <MemoryTimelineWidget memoryId={firstMemoryId} />
          </TabsContent>
          ...
          <TabsContent value="relationships" className="h-full m-0">
            <MemoryRelationshipsWidget memoryId={firstMemoryId} />
          </TabsContent>
