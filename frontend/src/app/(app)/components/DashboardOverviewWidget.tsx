    ...
    >
      {(summary) => (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-0 divide-x divide-y border-b">
          ...
          <div className="p-6 flex flex-col items-center justify-center text-center bg-blue-50/50 dark:bg-blue-900/10">
            <span className="text-3xl font-bold text-blue-600 dark:text-blue-400">{summary.running_agents}</span>
            <span className="text-xs text-muted-foreground mt-1 uppercase tracking-wider">Agents Running</span>
          </div>
          <div className="p-6 flex flex-col items-center justify-center text-center bg-green-50/50 dark:bg-green-900/10">
            <span className="text-3xl font-bold text-green-600 dark:text-green-400">{summary.active_workflows}</span>
